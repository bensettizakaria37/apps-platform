const apps = [
  {
    ...
    icon: "📄",
    title: "PDF → DOCX",
    desc: "Convertissez vos fichiers PDF en documents Word éditables en un clic.",
    color: "#1d4ed8",
    bg: "#eff6ff",
    badge: "Disponible"
  },
  {
    id: "ocr",
    icon: "🖼️",
    title: "OCR — Image → Texte",
    desc: "Extrayez le texte de n'importe quelle image ou PDF scanné. Supporte FR, EN, AR.",
    color: "#7c3aed",
    bg: "#f5f3ff",
    badge: "Disponible"
  },
  {
    ...
    icon: "🔒",
    title: "PDF Protégé",
    desc: "Ajoutez un mot de passe et des permissions à vos fichiers PDF.",
    color: "#9ca3af",
    bg: "#f9fafb",
    badge: "Bientôt"
  },
  {
    ...
    desc: "Réduisez la taille de vos PDFs sans perte de qualité visible.",
    color: "#9ca3af",
    bg: "#f9fafb",
    badge: "Bientôt"
  },
    ...
    <div style={{ maxWidth:"1000px", margin:"0 auto", padding:"48px 24px" }}>
      ...
      <div style={{ textAlign:"center", marginBottom:"56px" }}>
        ...
        <p style={{ color:"#6b7280", fontSize:"16px", maxWidth:"480px", margin:"0 auto" }}>
          Des outils simples, rapides et gratuits pour convertir, extraire et transformer vos fichiers.
        </p>
      </div>
        ...
        {apps.map(app => (
          <div
            ...
            style={{
              ...
              borderRadius:"16px",
              padding:"28px 24px",
              cursor: app.badge === "Disponible" ? "pointer" : "default",
              transition:"all 0.2s",
              opacity: app.badge === "Bientôt" ? 0.6 : 1,
          ...
          >
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:"8px" }}>
              ...
              <span style={{
                ...
                background: app.badge==="Disponible" ? "#dcfce7" : "#f3f4f6",
                color: app.badge==="Disponible" ? "#15803d" : "#9ca3af"
              }}>{app.badge}</span>
            </div>
            <p style={{ fontSize:"13px", color:"#6b7280", lineHeight:"1.6" }}>{app.desc}</p>
            {app.badge === "Disponible" && (
              <div style={{ marginTop:"16px", color: app.color, fontSize:"13px", fontWeight:"600" }}>
                Ouvrir →
              </div>
            )}
          </div>

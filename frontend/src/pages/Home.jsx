const apps = [
  ...
  { id:"ssl", icon:"🔒", title:"SSL Checker", desc:"Vérifiez la validité et les détails du certificat SSL de n'importe quel domaine.", color:"#059669", bg:"#f0fdf4" },
  { id:"csr", icon:"🔏", title:"CSR Decoder", desc:"Décodez et inspectez vos Certificate Signing Requests (CSR).", color:"#0ea5e9", bg:"#f0f9ff" },

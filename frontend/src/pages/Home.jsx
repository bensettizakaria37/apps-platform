    ...
    <div style={{
      ...
      <div style={{ maxWidth:"960px", margin:"0 auto" }}>
        <div style={{ textAlign:"center", marginBottom:"56px" }}>
          <p style={{ fontSize:"13px",fontWeight:"700",letterSpacing:"0.2em",textTransform:"uppercase",
            color:"#a29bfe",marginBottom:"16px",background:"rgba(108,92,231,0.2)",
            padding:"6px 16px",borderRadius:"20px",display:"inline-block",
            border:"1px solid rgba(162,155,254,0.3)" }}>FACTORY-TOOLS</p>
          <h1 style={{ fontSize:"48px",fontWeight:"800",color:"#f3f4f6",
            letterSpacing:"-2px",lineHeight:1.05,marginBottom:"14px" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)",
          ...
          {APPS.map((app, i) => {
            ...
            return (
              <div key={app.id} onClick={() => setPage(app.id)} style={{
                ...
                <div style={{ display:"flex", alignItems:"center", gap:"14px", marginBottom:"10px" }}>
                  ...
                  <span style={{ fontSize:"15px",fontWeight:"700",color:"#f3f4f6",
                    letterSpacing:"-0.3px" }}>{app.title}</span>
                </div>
                <p style={{ fontSize:"13px",color:"#6b7280",lineHeight:"1.6",
                  paddingLeft:"58px" }}>{app.desc}</p>
              </div>
            );
          })}
        </div>

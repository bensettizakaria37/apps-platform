...
const ICONS = {
  ...
  portscanner: { g:G, icon:<><rect x="10" y="18" width="28" height="12" rx="3" fill="white" opacity="0.9"/><circle cx="17" cy="24" r="2.5" fill="#6c5ce7"/><circle cx="24" cy="24" r="2.5" fill="#6c5ce7" opacity="0.6"/><circle cx="31" cy="24" r="2.5" fill="#6c5ce7" opacity="0.3"/><path d="M24 10 L24 16" stroke="white" strokeWidth="2" strokeLinecap="round"/></>, },
  dnshealth: { g:G, icon:<><circle cx="24" cy="24" r="14" fill="white" opacity="0.9"/><path d="M24 14 L24 24 L31 31" stroke="#6c5ce7" strokeWidth="2.5" strokeLinecap="round" fill="none"/><circle cx="24" cy="24" r="3" fill="#6c5ce7"/></>, },
